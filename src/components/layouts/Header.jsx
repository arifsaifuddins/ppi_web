      ...
      <div className="flex sticky top-0 py-2 text-slate-100 bg-teal-600 z-20">
        <div className="flex justify-between mx-auto md:w-[90%] md:px-0 relative w-full px-4">
          ...
          <div className="md:flex gap-x-1 items-center hidden">
            <NavLink to="/" className="py-2 px-3 hover:bg-teal-700 rounded-lg"><i className="fa mr-1 fa-house-chimney"></i> Home</NavLink>
            <NavLink to="/blogs" className="py-2 px-3 hover:bg-teal-700 rounded-lg"><i className="fa mr-1 fa-book-open"></i> Blogs</NavLink>
            <NavLink to="/organizations" className="py-2 px-3 hover:bg-teal-700 rounded-lg"><i className="fa mr-1 fa-file-lines"></i> Organizations</NavLink>
            <NavLink to="/about" className="py-2 px-3 hover:bg-teal-700 rounded-lg"><i className="fa mr-1 fa-briefcase"></i> About</NavLink>
          </div>
          <div className="flex gap-x-1 items-center">
            ...
            <NavLink to="/admin" className="py-2 px-3 hover:bg-teal-700 bg-teal-500 rounded-lg"><i className="fa mr-1 fa-user"></i> Admin</NavLink>
          </div>
          <div className="absolute right-0 top-16 scale-0 transition duration-500 md:w-96 w-[85%] md:mx-0 mx-4 mail text-slate-800 rounded-xl border">
            <Mailing />
          </div>
        </div>
        <div className="md:hidden gap-x-1 items-center flex fixed bottom-0 left-0 right-0 justify-around text-xl py-2 bg-teal-600">
          <NavLink to="/" className="py-2 px-3 hover:bg-teal-700 rounded-lg"><i className="fa fa-house-chimney"></i></NavLink>
          <NavLink to="/blogs" className="py-2 px-3 hover:bg-teal-700 rounded-lg"><i className="fa fa-book-open"></i></NavLink>
          <NavLink to="/organizations" className="py-2 px-3 hover:bg-teal-700 rounded-lg"><i className="fa fa-file-lines"></i></NavLink>
          <NavLink to="/about" className="py-2 px-3 hover:bg-teal-700 rounded-lg"><i className="fa fa-briefcase"></i></NavLink>
        </div>
      </div>
    </>
  );
