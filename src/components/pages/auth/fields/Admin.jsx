...
function AdminField() {
  ...
  return (
    <div className="p-4 bg-white shadow rounded-xl dark:bg-[#222222]">
      ...
      <input required type="text" placeholder="Admin Password..." onChange={(e) => setPass(e.target.value)} className="passed mt-2 bg-transparent py-2 pl-3 rounded-full text-lg  border outline-none border-teal-600 w-[100%]" />
