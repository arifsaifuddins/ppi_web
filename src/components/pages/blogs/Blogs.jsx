        ...
        <div className="flex flex-col lg:px-8 px-4 py-4 bg-white shadow rounded-xl w-[100%] h-max dark:bg-slate-800">
          ...
          <div className="flex flex-col mt-10">
            ...
            <div className="flex flex-col mt-8">
              <div className="flex flex-col rounded-xl shadow-lg hover:shadow-xl  overflow-hidden bg-white dark:bg-slate-800">
                <Link to="/blogs/id">
                  <div className="flex justify-end bg-cover pt-60 text-white bg-[url(/assets/img/default.jpg)] flex-col">
                    <h1 className="text-4xl font-bold p-4 bg-opacity-25 bg-slate-700">Ini Judul Poster</h1>
              ...
              <div className="flex items-center gap-4 py-10 mx-auto">
                <i className="fa fa-arrow-left-long pl-1 border-l-2 border-l-black"></i>
                ...
                <i className="fa fa-arrow-right-long pr-1 border-r-2 border-r-black"></i>
              </div>
            </div>
          </div>
        </div>
