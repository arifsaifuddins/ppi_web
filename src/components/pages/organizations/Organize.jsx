      ...
      <div className="flex gap-8 md:w-[90%] md:px-0 w-full lg:flex-row flex-col-reverse mx-auto lg:my-10 my-4 relative">
        ...
        <div className="flex flex-col lg:px-8 px-4 py-4 bg-white shadow rounded-xl w-[100%] h-max dark:bg-[#222222]">
          <div className="flex items-center border-b justify-between">
            <h1 className="text-2xl pb-4 text-teal-600"># <span className="title">Stuctures</span> <span className="dark:text-slate-100 text-[#222222] text-xl font-thin"> {'>'} <span className="sub">Presidents</span></span></h1>
