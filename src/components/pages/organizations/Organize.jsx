    ...
    <>
      ...
      <div className="flex gap-8 md:w-[90%] md:px-0 w-full lg:flex-row flex-col-reverse mx-auto lg:my-10 my-4 relative">
        <div className="flex flex-col lg:w-[30%] w-full lg:mx-0 gap-8">
          <div className="bg-white z-20 side shadow lg:rounded-xl lg:h-max overflow-y-auto transition-transform duration-700 lg:overflow-hidden dark:bg-[#222222] fixed left-0 top-0 bottom-0 pt-16 mt-9 lg:mt-0 lg:pt-0 w-[100%] pb-20 lg:pb-0 md:w-[45%] lg:relative lg:w-full lg:block -translate-x-[100%] lg:translate-x-0">
        ...
        <div className="flex flex-col lg:px-8 px-4 py-4 bg-white shadow rounded-xl w-full lg:w-[68%] h-max dark:bg-[#222222]">
          <div className="flex items-center border-b justify-between">
            <h1 className="text-2xl pb-4 text-teal-600"># <span className="title">Struktur</span> <span className="dark:text-slate-100 text-[#222222] text-xl font-thin"> {'>'} <span className="sub"></span></span></h1>
