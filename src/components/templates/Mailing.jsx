function Mailing() {
  return (
    <div className="p-4 bg-white shadow rounded-xl dark:bg-slate-800">
      ...
      <form method="post">
        <input required type="text" placeholder="Your Name..." className="subject mt-4 bg-transparent py-2 pl-3 rounded-full text-md  border outline-none border-teal-600 w-[100%]" />
