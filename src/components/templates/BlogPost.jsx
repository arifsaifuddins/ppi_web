...
function BlogPost({ data }) {
  ...
  return (
    <div className="flex flex-col p-4 rounded-xl w-full shadow-lg hover:shadow-xl bg-white dark:bg-transparent lg:hover:scale-[103%] transition-transform">
      ...
      <Link to={`/blog/${data.slug}`} ><h1 className="text-2xl text-teal-600 font-bold my-4 hover:text-teal-700 hover:underline">{data.title.length < 40 ? data.title : data.title.slice(0, 40) + '...'}</h1>
