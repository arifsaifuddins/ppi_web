...
function BlogSide({ data }) {
  ...
  return (
    <Link to={`/blog/${data.slug}`} className="flex p-4 gap-4 justify-between border-t hover:bg-slate-50 dark:hover:bg-[#222222]">
      ...
      <img src={phpurl + '/images/' + data.blog_poster} alt="poster" className="h-[80px] w-[100px] object-center rounded-xl" />
    </Link>
  );
}
